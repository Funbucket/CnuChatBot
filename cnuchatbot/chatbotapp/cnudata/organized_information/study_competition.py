...
def get_study_competition_answer():
    url = "https://plus.cnu.ac.kr/_prog/_board/?code=sub07_070808&site_dvs_cd=kr&menu_dvs_cd=070808"
    ...
    answer = list_card("스터디 및 공모전", titles[0], dates[0], urls[0])
