...
# dict = {}
# dict["title"] = titles[1]
# dict["description"] = dates[1]
# dict["imageUrl"] = None
# dict["link"] = {"web": urls[1]}
# print(answer)
# print(answer['template']['outputs'][0]['listCard']['items'])
# answer['template']['outputs'][0]['listCard']['items'].append(dict)
# print(answer['template']['outputs'][0]['listCard']['items'])